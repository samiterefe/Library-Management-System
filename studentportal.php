		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="studentportal.php">HLMS</a>
				</div>
		...
		<div class="slider">
			...
			<div class="carousel" data-flickity='{ "autoPlay": true }' ;>
				...
				<div class="carousel-cell" auto-play>
					<img src="images/astu1.png">
				</div>
				<div class="carousel-cell" auto-play>
					<img src="images/astu2.jpg">

				</div>
				<div class="carousel-cell" auto-play>
					<img src="images/astu3.jpg">
				</div>

				<div class="carousel-cell" auto-play>
					<img src="images/astu4.jpg">
				</div>
				<div class="carousel-cell" auto-play>
					<img src="images/astu5.jpg">
				</div>
		...
		<div class="container slide2">
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column">
					...
					Libraries are very helpful and economical too. They include books, magazines, newspapers,
					DVDs, manuscripts and more. In other words, they are an all-encompassing source of information.
					A public library is open to everyone for fulfilling the need for information. They are run by the government,
					schools, colleges, and universities. The members of the society or community can visit these libraries to enhance
					their knowledge and complete their research.By signing up in the button below Libraries play a vital role in providing
					people with reliable content. They encourage and promote the process of learning and grasping knowledge. The book worms
					can get loads of books to read from and enhance their knowledge. Moreover, the variety is so wide-ranging that one mostly
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column">
					...
					The public library requires nothing of its visitors: no purchases, no membership
					fees, no dress code. You can stay all day, and you don’t have to buy anything. You don’t need money or a library
					card to access a multitude of on-site resources that includes books, e-books and magazines, job-hunting assistance, computer stations,
					free Wi-Fi, and much more. And the library will never share or sell your personal data.In a country riven by racial, ethnic, political,
					and socioeconomic divides, libraries still welcome everyone. We are open spaces.
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column">
					<div class="page-header col-lg-offset-1">
						<h2>Why Us?</h2>
