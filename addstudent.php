...
if (isset($_POST['submit'])) {
    ...
    $phone = sanitize(trim($_POST['phoneNumber']));
...
<div class="container">
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="index.php">HDLMS</a>
        </div>
</div>
        ...
        <div class="container">
            <form class="form-horizontal" role="form" action="addstudent.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="matric_no" placeholder="ID NO" id="password" required>
                    </div>
                </div>
                <div class="form-group">
