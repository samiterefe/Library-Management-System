...
if (isset($_POST['submit'])) { //isset — Determine if a variable is declared and is different than null

    $title = sanitize(trim($_POST['title'])); // sanitize removing any illegal character from the data
...
<div class="container">
    ...
    <script type="text/javascript">
        window.onload = function() { //as soon as the page loads load this
